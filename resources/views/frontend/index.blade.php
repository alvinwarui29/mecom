...
@section('main')
@php
    $sliderImageURLo = asset('frontend/assets/imgs/slider/slider-1.png');
    $sliderImageURLi=asset('frontend/assets/imgs/slider/slider-2.png')
  @endphp
  ...
  <section class="home-slider position-relative mb-30">
            <div class="container">
                <div class="home-slide-cover mt-30">
                    ...
                    <div class="single-hero-slider single-animation-wrap"  style="background-image: url('{{ $sliderImageURLo }}')">
                        ...
                        <div class="single-hero-slider single-animation-wrap"  style="background-image: url('{{ $sliderImageURLi }}')">
                            <div class="slider-content">
                                <h1 class="display-2 mb-40">
                                    Fresh Vegetables<br />
                                    Big discount
