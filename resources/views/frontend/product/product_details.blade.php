...
<div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <span></span> <a href="shop-grid-right.html">{{ optional($product->category)->category_name  }}</a> <span></span> {{ optional($product->subcategory)->subcategory_name  }} <span></span>{{ $product->product_name }} 
                </div>
            </div>
        </div>
...
<li class="mb-5">Category:<span class="text-brand"> {{ optional($product->category)->category_name }}</span></li>

<li>SubCategory: <span class="text-brand">{{ optional($product->subcategory)->subcategory_name }}</span></li>
</ul>
...
<div class="col-lg-3 col-md-4 col-12 col-sm-6">
    <div class="product-cart-wrap hover-up">
        <div class="product-img-action-wrap">
            <div class="product-img product-img-zoom">
                <a href="{{ url('products/details/'.$product->id.'/'.$product->product_slug) }}" tabindex="0">
    ...
    @endphp
        ...
        <div class="product-content-wrap">
            <h2><a href="{{ url('products/details/'.$product->id.'/'.$product->product_slug) }}" tabindex="0">{{ $product->product_name }}</a></h2>
